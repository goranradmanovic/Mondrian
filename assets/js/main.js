...
function togglePaints() {
	...
	pageElements[1].addEventListener('click', (event) => {
		...
		if (event.target.checked) {
			...
			//Header link
			pageElements[0].setAttribute('checked', 'https://www.piet-mondrian.org/composition-ii-in-red-blue-and-yellow.jsp'); //Link href
			...
			//Header link
			pageElements[0].setAttribute('checked', 'https://www.piet-mondrian.org/composition-with-large-red-plane-yellow-black-gray-and-blue.jsp');
